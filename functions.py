...
def get_brands(user_input,Node):
    return match_list(user_input,Node,Brand_list.keys())

def get_types(user_input,Node):
    return match_list(user_input,Node,Brand_list[Node.AllAnswers["Brand"]])


#All generated Questions are generated by this function
def ask_reference(Text,Reference,Node):
    print("Node allanswers:", Node.AllAnswers[Reference])
...
def ask_types(Node):
    return ask_reference("What types are your trucks from ","Brand",Node)
